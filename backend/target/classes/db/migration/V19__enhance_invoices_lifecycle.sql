-- Migration V19: Enhance invoices table for full lifecycle support
-- This migration adds columns to support delivery tracking, locking, and void operations
...
-- Set initial values for existing invoices
UPDATE invoices
